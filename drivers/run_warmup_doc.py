...
import transformers
from utils.eval_mrr_doc import passage_dist_eval
...
def main():
    ...
    if args.do_train:
        ...
        def train_fn(line, i):
            return configObj.process_fn(line, i, tokenizer, args,0)

        with open(args.data_dir+"/triples.train.doc.tsv", encoding="utf-8-sig") as f:
